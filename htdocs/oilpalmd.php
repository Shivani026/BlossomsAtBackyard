...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Oilpalm)</a></div></hr>
...
<img src="oildef1.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18" align="justify">Soil application of MOP@2kg/tree</p>
</div>
...
<img src="oildef2.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of MgSO4@250g/tree</p>
</div>
...
<img src="oildef3.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Young and newly developing leaves become deformed. Leaflets become abnormal which do not split as usual. Leaves have a serrated zigzag appearance. The apical shoot exhibits blackening and death. Sterilising and malformation of reproductive structures. Low and abnormal fruits.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of borax@0.5kg/tree/year</p>
</div>
</div>
</div>
<div class="footer">
