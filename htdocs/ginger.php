...
<hr style="border-width:20px; border-color:#F00E1F"><div class="hr-container" style="top:-15px;left:41%"><p>GINGER</p></div></hr>
<img src="gin1.png" style="height:180px;width:330px;position:relative;left:250px;top:10px;bottom:10px;border-radius:6px">
<p style="font-weight:bold;font-size:18px;">Varieties:</p>
Rio de Janeiro, Maran Nadan, Suruchi,<br>
Suravi, Suprabha, Himagiri,IISR Varada,<br>
IISR Mahima and IISR Rejatha Athira<br>
...
Treat the seed rhizomes with Mancozeb or Copper oxychloride 3 g/lit or 200 ppm Streptocycline for 30 minute Spacing
Irrigated crop - 40 x 20 cm in ridges and furrows.Rainfed crop - Raised beds of 20 x 20 cm or 25x 25 cm
<p style="font-weight:bold;font-size:18px;">Manures and Manuring:</p>
