...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Jasmine)</a></div></hr>
...
<img src="jasdef1.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Nitrogen Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Stunted plant growth;Old leaves turn yellow in color</p>
...
<img src="jasdef2.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Phosphorus Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Pink color pigmentation seen in old leaves; stunted plant growth</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of DAP 2% twice at fortnightly interval</p>
</div>
...
<img src="jasdef3.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Potassium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Symptom first visible on older leaves as marginal chlorosis and become necrotic drying form tip towards base.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of KCl@0.5%</p>
</div>
...
<img src="jasdef4.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Calcium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Leaf growth will be inhibited; scorching symptoms occur in new leaves as welk as in tip of the plant</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of CaCl2@1-2%</p>
</div>
...
<img src="jasdef5.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Magnesium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Symptoms seen in old leaves; ouuurence of interveinal chlorosis</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="jasdef6.jpg" style="border-radius:10px;left:335px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of CaSO4 @ 0.5%</p>
</div>
...
<img src="jasdef7.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Newly emerging leaves are malformed.  Plants show shunted growth.  Chlorotic streaks appear perpendicular to the veins.  Incomplete leaf formation and inhibition of flower. </p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="jasdef8.jpg" style="border-radius:10px;left:330px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Iron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Thin leaves with interveinal chlorosis.  Later the leaves become pale green colour.  Older leaves remain green.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<div class="panel">
<p style="font-size:22px;font-weight:bold;left:350px;position:relative">Copper Deficiency</p>
<img src="jasdef9.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Copper Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Dark green colour of leaves.  Twisted and malformed and shriveled leaves with busty growth.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of CuSO4 2-5 g/plant or Foliar spray of CuSO4@ 0.25% at fortnightly intervals.</p>
</div>
...
<img src="jasdef10.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Manganese Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Interveinal chlorosis of leaves.  Leaves show yellowish green background with fine nature of green veins.  Leaves become thicker</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of MnSO4 @ 5-10 g/plant or Foliar spray of MnSO4 0.5% at fortnightly intervals.</p>
</div>
...
<img src="jasdef11.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
