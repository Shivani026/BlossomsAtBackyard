...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Tea)</a></div></hr>
...
<img src="teadef1.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Nitrogen Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Older leaves become yellow in color; size of the leaf will be affected</p>
...
<img src="teadef2.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Phosphorus Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Pigmentation seen in older leaves; stunted plant growth</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar sprY of DAP@1%</p>
</div>
...
<img src="teadef3.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Potassium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Marginal chlorosis occur in old leaves</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="teadef4.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Magnesium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Yellowing symptom seen in older leaves</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of MgSO4@1.0%</p>
</div>
...
<img src="teadef5.jpg" style="border-radius:10px;left:335px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Sulphur Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Yellowing of young leaves; elongation of leaf growth will be affected</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of CaSO4@1-2%</p>
</div>
...
<img src="teadef6.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Plant tip and flower bud will be afected; leaf size become small as well as malformed</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="teadef7.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Copper Deficiency Symptoms</p>
<p style="font-size:18" align="justify">young leaves become pale yellow in color</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of CuSO4@1-2%</p>
</div>
...
<img src="teadef8.jpg" style="border-radius:10px;left:330px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Iron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Youn leaves become yellow in color; Occurence of interveinal chlorosis</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="teadef9.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Manganese Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Young leaves become yellow; veins remain green in color</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of MnSO4@1.0%</p>
</div>
</div>
</div>
<div class="footer">
