...
<title>Blossoms at Backyard : Home : Spice Crops</title>
</head>
<style>
body { 
margin:0; 
...
.bg-img {
  background-image: url("bg15.jpeg");
...
<hr style="border-width:20px;border-color:#BA5E0C;"><div class="hr-container" style="left:380px"><a>Major Spices</a></div></hr>
...
<hr style="border-width:20px;position:absolute;top:230px;width:93%;border-color:#BA5E0C;"><div class="hr-container" style="left:380px;top:235px;"><a>Seed Spices</a></div></hr>
   <div class="img-container" style="left:85px;top:280px;width:500px;height:150px">
  <a href="coriander.php">
  <img src="coriander.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Coriander</div></a>
  </div>
</div>
   <div class="img-container" style="left:350px;top:280px;width:500px;height:150px">
  <a href="fenugreek.php">
  <img src="fenugreek.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Fenugreek</div></a>
  </div>
</div>
 <div class="img-container" style="left:620px;top:280px;width:500px;height:150px">
  <a href="fennel.php">
  <img src="fennel.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Fennel</div></a>
  </div>
 </div>
<hr style="border-width:20px;opacity:0;position:absolute;top:670px;width:100%""><div class="hr-container" style="position:absolute;top:670px"><a></a></div></hr>
</div>
<div class="footer">
