...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Grapes)</a></div></hr>
<button class="accordion"><i class="fas fa-angle-down"></i>&nbsp Phosphorous</button>
<div class="panel">
<p style="font-size:22px;font-weight:bold;left:350px;position:relative">PhosphorousDeficiency</p>
<img src="nitrodef6.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Phosphorous Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Pigmentation seen in old leaves; leaf growth rate will be affected</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of super phosphate or foliar spray of DAP@1-2%</p>
</div>
...
<img src="caldef6.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of CaSO4 1% or soil application of gypsum @ 50 kg/ha.</p>
</div>
...
<img src="suldef6.jpg" style="border-radius:10px;left:335px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Sulphur Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Whole orchard or spot-wise stunted growth of pale-green plants.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of MgSO4@1%</p>
</div>
...
<img src="borondef6.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Poor fruit set clusters will tend to be small, and berries will not fully develop on the rachis.  Terminal buds may not break in the spring, and ends of shoots sometimes are distorted.  Borax or borate, B carriers, can be sprayed on in the spring when needed.  Pre-bloom sprays seem to be an effective way to get B into flower parts. Use foliar applications at an annual rate of one pound of actual boron per acre.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of Borax 0.2% at soil application of Borax 25-50 g/plat.</p>
</div>
...
<img src="irondef6.jpg" style="border-radius:10px;left:330px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Iron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Leaf veins remain green interveinal portion turns yellow young leaves small but not deformed.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of 0.5% FeSO4</p>
</div>
...
<img src="mangdef7.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Manganese Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Symptoms first appear as interveinal chlorosis, or yellowing of the younger terminal leaves.Applying fertilizer-grade manganese sulfate at 20 to 40 gm per vine, or 100 to 200 kg per acre, depending on vine size and severity of the deficiency.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar application of Mn can be sprayed for immediate effect mix manganese sulfate at the rate of 160 gram plus 80 gram of hydrate lime per 200 litres of water.  Two application usually will provide season-long control of manganese symptoms.  First appln.just after bloom or when symptoms first appear and second two weeks later.</p>
</div>
...
<img src="zincdef6.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Zinc Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Poor fruit set and stunted shots with small, misshapen leaves foliar application of zinc is the most effective method for treating Zn deficiency.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Neutral zinc products containing 50-52% Zn, or zinc oxide (75-805 Zn) are both effective as foliar sprays.  Zinc spray applications are most effective in improving fruit set when applied during the period of two weeks prior to bloom up to full bloom.  If foliar deficiency symptoms persist or reappear, a second application may be necessary.</p>
</div>
</div>
</div>
<div class="footer">
