...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Blackpepper)</a></div></hr>
...
<img src="pepdef1.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Potassium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Reduced growth.  Leaves develop characteristic bronzing followed by necrotic lesions along the veins and leaf fall.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of FeSO4@0.5kg/tree . Foliar spray of K2SO4 1% at weekly intervals.</p>
</div>
...
<img src="pepdef2.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Magnesium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Interveinal chlorosis of immature and recently matured leaves.  Necrotic lesions develop within the chlorotic areas.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of dolomite 0.5kg/tree. Foliar spray of MgSO4 1% at fortnightly intervals.</p>
</div>
...
<img src="pepdef3.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Young leaves become small and malformed</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of borax@0.5 kg/tree</p>
</div>
...
<img src="pepdef4.jpg" style="border-radius:10px;left:330px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Iron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Interveinal chlorosis of young leaves veins remain green and leaf size reduced.  In severe cases, whole leaf become chlorotic and yellow and fall.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of FeSO4@0.5 kg/tree. Foliar spray of FeSO4 1.0% at fortnightly intervals.</p>
</div>
...
<img src="pepdef5.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Manganese Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Yellowing of young leaves; veins remain green</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of MnSO4</p>
</div>
</div>
</div>
<div class="footer">
