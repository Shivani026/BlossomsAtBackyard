...
<hr style="border-width:20px; border-color:#179D9F"><div class="hr-container" style="top:-15px;left:40%"><p>GARDEN WASTE</p></div></hr>
<p style="font-weight:bold;font-size:18px;">Recycle of garden wastes<br>Scope</p>
...
<p style="font-weight:bold;font-size:18px;">Feed ingredients</p>
...
<br><img src="gar1.png" style="height:250px;width:750px;position:relative;left:60px;top:20px;bottom:10px;border-radius:6px"><br><br>
<p style="font-weight:bold;font-size:18px;">Process</p>
1.Ideal tank size for small scale vermicompost production is 10’ x 6’ x 2.5’ (150 cu .ft.)<br>
2.Create adequate no. of holes (about 8 holes of 5 cm. diameter at the bottom) to facilitate drainage of excess water<br>
3.Bedding comprise of broken bricks, stone pieces, saw dust, sand and soil<br>
4.Release earthworms in this bedding<br>
5.Pour the feed mix over this bedding of earthworms of about 15 to 20 cm thick<br>
6.Pre decomposed material need not be added in layers but its depth should not be more than 1.5 to 2 feet<br>
7.Tank is covered with thatched roof to maintain the moisture of the tank feed (40% moisture should be maintained)<br>
Under sub optimal moisture conditions the earthworms have a tendency to move downwards towards the bed of the tank. When the moisture, temperature and organic matter are optimum, the size, weight and cocoon producing capacity of earthworm’s increases.<br>
Conversion: One kilogram of worms numbering about 600 to 1000 can convert 25 to 45 kg. of wet waste per week. The compost recovery would be around 25 kg per week under well managed conditions. <br>
...
<p style="font-weight:bold;font-size:18px;">Conventional sieve</p>
...
<p style="font-weight:bold;font-size:18px;">Methods of waste treatment by Earthworms</p>
Solid waste materials may be spread out over the soil surface, usually on pastures. But sometimes on crops or in forests. To be incorporated directly into the soil – earthworms are important contributors to the burial and decomposition of the waste materials.
<br>Wastes may be stacked into heaps or placed in bins, where they are treated like compost heaps-earthworm activity results in the production of large quantities of earthworm casts, which are widely sold as manure.
</div>
<div class="footer">
