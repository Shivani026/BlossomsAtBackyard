...
<title>Blossoms at Backyard : Home : Fruit Crops</title>
</head>
<style>
body { 
margin:0; 
...
<hr style="border-width:20px;border-color:#FFC603;"><div class="hr-container"><a>Tropical and sub-tropical fruits</a></div></hr>
 <div class="img-container" style="left:25px;top:70px;width:500px;height:150px">
  ...
  <a href="lime.php">
  <img src="lime.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Lime</div></a>
  </div>
 </div>
 <div class="img-container" style="left:475px;top:250px;width:500px;height:150px">
  <a href="sweetorange.php">
  <img src="sweetorange.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Sweet-orange</div></a>
  </div>
 </div>
 <div class="img-container" style="left:700px;top:250px;width:500px;height:150px">
  ...
  <a href="ber.php">
  <img src="ber.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Thai apple(Ber) </div></a>
  </div>
 </div>
