...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Coffee)</a></div></hr>
...
<img src="cofdef1.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Nitrogen Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Older leaves become yellow in color; reduced leaf size</p>
...
<img src="cofdef2.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Phosphorus Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Pink or purple pigmentation appaer in old leaves</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of DAP@2.0%</p>
</div>
...
<img src="cofdef3.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Potassium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Occurence of marginal chlorosis in older leaves</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray fo K2SO4@1%</p>
</div>
...
<img src="cofdef4.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Calcium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Characterized narrow land of marginal chlorosis of leaves turning into necrotic fallow.  Leaves become small, growth shunted.  Youngest leaves with thickened secondary veins.  Distal end of midrib interveinal and marginal chlorosis.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="cofdef5.jpg" style="border-radius:10px;left:335px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Sulphur Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Yellowing of young leaves; size of the leaf become small</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application sulphur fertilizer</p>
</div>
</div>
</div>
<div class="footer">
