...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Rose)</a></div></hr>
...
<img src="rodef1.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Phosphorus Deficiency Symptoms</p>
<p style="font-size:18" align="justify">The deficiency of P causes complete cessation of elongation,older leaves becoming irregularly necrotic and marginal chlorosis and premature death are caused. P deficiency causes a blue or dark green coloration of leaves.Flowering is delayed with reduction in size & number of leaves.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Application of super phosphate was very effective to control the deficiency.</p>
</div>
...
<img src="rodef2.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray K2SO4 1% at fortnightly intervals.</p>
</div>
...
<img src="rodef3.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
...
<img src="rodef4.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
