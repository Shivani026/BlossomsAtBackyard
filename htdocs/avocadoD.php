...
<div class="top-container">
  <div class="topnav">
	 ...
	 <a style="cursor:pointer">Explore&nbsp <i class="fa fa-angle-down"></i></a>
       ...
       <a href="valueadd.php">Fertilizers and value addition</a>
      </div>
	</div>
...
<div id="mySidenav" class="sidenav" onmouseleave="closeNav()">
  ...
  <a href="protection.php">Plant protection</a>
</div>
...
<p style="font-size:18" align="justify"></p>
...
<div class="footer">
	...
	<div><a href="https://www.facebook.com/blossomsatbackyard" style="position:relative;left:480px;top:-175"><i class="fab fa-facebook-square" style="font-size:35px;color:#0F19B6"></i></a><a href="https://www.instagram.com/blossomsatbackyard/" style="position:relative;left:500px;top:-175;height:20px"><i class="fab fa-instagram" style="font-size:35px;color:#9E0562"></i></a></div>
	<div><hr style="width:1200px;position:relative;top:-160px;left:60px;border-color:white"></hr></div>
	<div class="container" style="width:500px;height:20px;font-family:Candara Light;font-size:16px;color:white;background-color:rgba(0,0,0,0.0);position:relative;top:-145px;left:780px"><a href="Terms.php" style="color:white">Terms of service</a>&nbsp &nbsp &nbsp <a href="Aboutus.php" style="color:white">About Us</a>&nbsp &nbsp &nbsp <a href="help.php" style="color:white">Help</a>&nbsp &nbsp &nbsp <a href="directory.php" style="color:white">Directory</a>&nbsp &nbsp &nbsp <a href="FAQ.php" style="color:white">FAQ</a>&nbsp &nbsp &nbsp <a href="events.php" style="color:white">Events</a>
	<div class="container" style="width:350px;height:200px;font-family:Candara Light;font-size:16px;color:white;background-color:rgba(0,0,0,0.0);position:relative;top:-40px;left:-700px"><p style="font-weight:bold;font-size:20px">Get in touch with us<br>Contact us at:</p><p>Shivani Awatade<br>Sushmita Paunikar<br>G.S.College of Commerce and Economics, Nagpur<br>Phone No. +07172258700<br>Email us at: blossomsatbackyrd@gmail.com<br>©Blossoms at Backyard 2020</p></div>
	</div>
	</div>
</div>
<script>
