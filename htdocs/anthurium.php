...
<hr style="border-width:20px; border-color:#F01940"><div class="hr-container" style="top:-15px;left:40%"><p>ANTHURIUM</p></div></hr>
<p style="font-weight:bold">Varieties</p>
<p style="font-size:15px">
Red             : Temptation, Tropical Red, Red Dragon, Verdun Red, Flame, Mauritius Red .<br>
Orange        : Mauritius Orange, Peach, Casino, Sunshine Orange, Nitta. White          : Acropolis, Linda de Mol, Mauritius White, Lima, Manoa Mist.<br>
Pink             : Abe Pink, Candy Stripe, Passion.<br>
Green          : Midori, Esmaralda.<br>
Bicoloured  : Titicaca, Jewel, Akapana, Cardinal.<br>
Others         : Fantasia (cream with pink veins), Chocos, Chicos (chocolate brownish red).<br>
</p>
<img src="anthu1.jpg" style="height:150px;width:200px;position:relative;left:80px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu2.jpg" style="height:150px;width:200px;position:relative;left:150px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu3.jpg" style="height:150px;width:200px;position:relative;left:220px;top:10px;bottom:10px;border-radius:6px">
<p style="position:relative;left:100px;"> &nbsp Tropical Red &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Calisto &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  Acropolis </p>
<img src="anthu4.jpg" style="height:150px;width:200px;position:relative;left:80px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu5.jpg" style="height:150px;width:200px;position:relative;left:150px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu6.jpg" style="height:150px;width:200px;position:relative;left:220px;top:10px;bottom:10px;border-radius:6px">
<p style="position:relative;left:100px;"> &nbsp Fantasia &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbspGrace &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Laguna </p>
<img src="anthu7.jpg" style="height:150px;width:200px;position:relative;left:80px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu8.jpg" style="height:150px;width:200px;position:relative;left:150px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu9.jpg" style="height:150px;width:200px;position:relative;left:220px;top:10px;bottom:10px;border-radius:6px">
<p style="position:relative;left:100px;"> &nbsp Condor &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp caesar &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp Cheers </p>
<img src="anthu10.jpg" style="height:150px;width:200px;position:relative;left:80px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu11.jpg" style="height:150px;width:200px;position:relative;left:150px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu12.jpg" style="height:150px;width:200px;position:relative;left:220px;top:10px;bottom:10px;border-radius:6px">
<p style="position:relative;left:100px;"> &nbsp Grace &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Meringue &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp  &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  Aymara </p>
<img src="anthu13.jpg" style="height:150px;width:200px;position:relative;left:80px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu14.jpg" style="height:150px;width:200px;position:relative;left:150px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu15.jpg" style="height:150px;width:200px;position:relative;left:220px;top:10px;bottom:10px;border-radius:6px">
<p style="position:relative;left:100px;"> &nbsp Safari &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Midori &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Laguna </p>
<img src="anthu16.jpg" style="height:150px;width:200px;position:relative;left:80px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu17.jpg" style="height:150px;width:200px;position:relative;left:150px;top:10px;bottom:10px;border-radius:6px">
<img src="anthu18.jpg" style="height:150px;width:200px;position:relative;left:220px;top:10px;bottom:10px;border-radius:6px">
<p style="position:relative;left:100px;"> &nbsp Pistache&nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp Poopo &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  Tropic Night </p>
