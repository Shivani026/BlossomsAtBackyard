...
<hr style="border-width:20px; border-color:#179D9F"><div class="hr-container" style="top:-15px;left:30%"><p>PRINCIPLES OF LANDSCAPING</p></div></hr>
<p style="position:relative;top:10px">The importance of landscaping is now realized by every one in the world. The gardens serve the purpose of public recreation by refreshing the body and the mind. They are virtually a retreat for the public from the harsh strains and stresses of public life.
Landscaping is done with a view to create a natural scene by planting of lawn, trees and shrubs. It is the imitation of nature in the garden and improves the total living environment of the people. We live in a vast planet which is characterized by different types of landscaping depending upon prevailing geographical and agroclimatic conditions. There are mountains, hills, glens, valleys, seas, rivers, forests, plains, deserts, lakes, swamps, streams etc. which comprise major part of natural landscape. Man has copied the natural elements for improving landscape around him and converted certain areas in the form of garden for his pleasure.</p>
<p style="font-weight:bold;font-size:18px;">Basic Principles</p>
Before actually drawing the master-plan, the following points should be kept in mind in home landscaping.
<p style="font-weight:bold;font-size:18px;">Background </p>
The background in a garden, whether a wall, tall trees or a hedge should be neutral in nature; that is to say this should not become a distracting feature over the main features of the garden.
<p style="font-weight:bold;font-size:18px;">Contrast </p>
The design should be such that it should break monotony. To achieve this, a variation in form, texture, or colour has to be brought in.
<p style="font-weight:bold;font-size:18px;">Balance or Proportion</p>
...
<p style="font-weight:bold;font-size:18px;">Open Centre </p>
The central area of the garden should be left out of any items of major interest. The best way to achieve this is to have a lawn, which also gives an effect of largeness to the property. A specimen shrub in the centre of the lawn is unsuitable as this counters the principle of spaciousness, but a tree branching at higher levels from the ground could be planted.
<p style="font-weight:bold;font-size:18px;">Repetition </p>
...
<p style="font-weight:bold;font-size:18px;">Rhythm :</p>
A landscape designer should have an artistic sense to understand how to bring in rhythm in the design. Arranging the different elements haphazardly, without harmony, does not enhance beauty. Harmonious lines, often artistically curved, bring in rhythm to the landscape. A group of shrubs in front of a rockery breaks the rhythm. Repetition of certain elements, such as form, enhances the rhythm.
<p style="font-weight:bold;font-size:18px;">Variety :</p>
To break the monotony in a garden, variety is essential. This is achieved by contrast of colour, form, and texture. Planting of different seasonal flowers all in red colour, does not necessarily mean variety.
<br>Besides these, a design should be simple, easy to maintain, and provide comfort for inmates
</div>
<div class="footer">
