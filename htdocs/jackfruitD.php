...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Jackfruit)</a></div></hr>
...
<img src="jackdef1.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Magnesium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Yellowing of older leaves between lateral veins on either side of midrib.  Chlorosis spreads from margin towards midrib</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of dolomite 5 kg/tree/year.</p>
</div>
...
<img src="jackdef2.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Fruits show splitting or cracking with characteristic reddish purple colour.  Leaves show chlorosis and brittleness.  Terminal shoot poorly developed.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of borax 25 g/tree/year.</p>
</div>
...
<img src="jackdef3.jpg" style="border-radius:10px;left:330px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Iron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Young leaves show interveinal chlorosis.   Veins remain green.  In severe cases entire leaf becomes yellow.  The midrib remain green with stunted growth.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of FeSO4 0.5 kg/tree/year.</p>
</div>
...
<img src="jackdef4.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Manganese Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Leaves become yellow in color; veins remain green in color</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
