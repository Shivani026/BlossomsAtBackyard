...
<hr style="border-width:20px; border-color:#F00E1F"><div class="hr-container" style="top:-15px;left:41%"><p>CARDAMOM</p></div></hr>
<img src="car1.png" style="height:180px;width:330px;position:relative;left:250px;top:10px;bottom:10px;border-radius:6px">
<p style="font-weight:bold;font-size:18px;">Varieties</p>
Malabar : Mudigree 1, Mudigree 2, PV 1, ICRI 1, ICRI 3, TKD 4,IISR Suvarna, IISR Vijetha, IISR Avinash, Mysore : ICRI 2, Vazhukka : PV2, Njallani (Green gold).
...
<p style="font-weight:bold;font-size:18px;">Preparation of the field</p>
