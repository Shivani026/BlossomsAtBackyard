...
<hr style="border-width:20px; border-color:#192272"><div class="hr-container" style="top:-15px;left:41%"><p>ROSEMARY</p></div></hr>
<img src="rosem1.png" style="height:300px;width:800px;position:relative;left:40px;top:10px;bottom:10px;border-radius:6px"><br><br>
...
<p style="font-weight:bold;font-size:18px;">Age</p>
Perennial crop. Can be grown commercially until twelve years.
<p style="font-weight:bold;font-size:18px;">Land preparation</p>
...
<p style="font-weight:bold;font-size:18px;">Seed size</p>
50,000 seedlings - ha.
...
<p style="font-weight:bold;font-size:18px;">Crop Protection</p>
