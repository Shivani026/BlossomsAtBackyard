...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Pineapple)</a></div></hr>
...
<img src="pindef1.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
...
<img src="pindef2.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Phosphorus Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Symptoms appear on older leaves. The leaves are small and narrow with purplish or bronze discolouration. Leaves develop necrotic areas and fall off.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of phosphotic fertilizer or Foliar spray of DAP@2%</p>
</div>
...
<img src="pindef3.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Potassium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Potassium symptoms appear first in older leaves older leaves orange, yellow to pale green colour.  Upper surface show reddish purple discoloration.  Young leaves remain dark green.  Leaves curl down and lose luster and turgidity.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="pindef4.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Calcium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Young emerging leaves show chlorosis become pale green and curl down.  Leaves later turn to greenish pink or red colour.  The terminal shoot poorly developed.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Application of CaSO4 @ 2kg / tree/year.</p>
</div>
...
<img src="pindef5.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Fruit necrosis which begins with the browning of inner most part of the mesocarpic tissues at the time of endocarp hardening.  This is extended towards the epicarp resulting into brownish black areas on the fruit surfaces depending of the severity of the disorder.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="pindef6.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of 1-2% CuSO4.</p>
</div>
...
<img src="pindef7.jpg" style="border-radius:10px;left:330px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Iron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Symptoms are first seen in the youngest leaves.  The leaves eventually turn completely chlorotic.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of FeSO4@0.5-1.0%</p>
</div>
...
<img src="pindef8.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Zinc Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Stunted growth narrowing of leaves with pale green or yellow.  Inter-veinal chlorosis starting from tip of leaflets and spreading to the remaining area leaving only the midrib green. </p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
