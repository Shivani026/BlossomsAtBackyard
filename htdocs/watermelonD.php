...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:290px;top:-35px;color:black"><a>Deficiencies and Disorders (Watermelon)</a></div></hr>

<p style="font-size:22px;font-weight:bold;left:350px;position:relative">Manganese Deficiency</p>
<img src="mangdef6.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Manganese Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Fine network of green veins as a light green background on young leaves. Leaf remains fairly green. Dark green irregular bands on mature leaves, along the midrib.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of 0.5% MnSO4.</p>
</div>
</div>
<div class="footer">
