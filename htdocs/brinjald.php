...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Brinjal)</a></div></hr>
...
<img src="brindef1.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Nitrogen Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Light green to a yellowing symptom first occurs in older leaves progressing to the newer leaves.  Firing of the older leaves.  Leaves plants stunted with hard, fibrous and slender stems. Older leaves become stiff.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of Urea 2% twice at weekly interval.</p>
</div>
...
<img src="brindef2.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Potassium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Older leaves affected first.  Leaf tips and margins turn yellow and then become scorched continuing inward to the leaf center.  Leaf margin cup downward interveinal leaf necrosis restricted growth.  Poorly developed roots and fruit.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar application of K2SO4 @1%.</p>
</div>
...
<img src="brindef3.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Magnesium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Interveinal chlorosis of older larger leaves veins remain green necrotic areas with time and die.  Leaf margins curl upward purple tinting on older leaves smaller fruit.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of MgSO4 @2%.</p>
</div>
...
<img src="brindef4.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Calcium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Necrosis at tip and margins of newer immature leaves nearest the terminal growth with a distorted appearance stems thick fibrous retarded growth terminal buds die.  Brown to Black leathery spots on the underside of fruits.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of 2% Calcium sulphate twice at weekly intervals.</p>
</div>
...
<img src="brindef5.jpg" style="border-radius:10px;left:335px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Sulphur Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Newer leaves light green to yellowish leaf veins appear lighter in color leaf tips cupping downward stems hard fibrous and spindly.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of K2SO4 1%.</p>
</div>
...
<img src="brindef6.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Leaves chlorotic small thick brittle and misshapened the base of the new leaves wrinkled or deformed internodes short with a resetting appearance terminal bud dies.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of borax 5Kg/ha or foliar spray of borax 0.2%</p>
</div>
...
<img src="brindef7.jpg" style="border-radius:10px;left:330px;position:relative;top:0px;width:250px;height:300px">
