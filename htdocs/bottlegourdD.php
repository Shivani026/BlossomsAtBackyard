...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Bottle Gourd)</a></div></hr>
...
<img src="botdef1.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Potassium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Lower (old) leaves show puckering and yellowing in interveinal areas and marginal scorching.</p>
...
<img src="botdef2.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Calcium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Leaf growth will be affected; terminal flower bud and growth of the fruit will be severely affected</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of CaCl2@0.5%</p>
</div>
...
<img src="botdef3.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of MgSO4@0.5%</p>
</div>
...
<img src="botdef4.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Buckering of leaves; leaves become brittle when symptoms seem severe</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="botdef5.jpg" style="border-radius:10px;left:330px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Iron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Chlorosis occur in young leaves; leaves turn into yellow</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
