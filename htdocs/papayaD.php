...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Papaya)</a></div></hr>
...
<img src="nitrodef3.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Nitrogen Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Nitrogen deficiency causes slow growth and paler leaves with reduced leaf area and rate of leaf production.  Leaf petioles short, thin and compressed.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of urea@2%</p>
</div>
...
<img src="phosdef3.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Phosphorus Deficiency Symptoms</p>
<p style="font-size:18" align="justify">The deficiency of P causes complete cessation of elongation,older leaves becoming increasingly irregularly necrotic, leaf production is reduced, and marginal chlorosis and premature death are caused. P deficiency causes a blue or dark green coloration of leaves.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of phosphotic fertilizer as per the recommendation</p>
</div>
...
<img src="potadef3.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Potassium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Deficiency of potassium causes marked reduction in growth, interval profusely smaller, premature yellowing of plant.  Purplish brown patches appear at the base of the petioles.  Fruits are badly shaped, poorly filled and unsuitable for marketing.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of KCl@2%</p>
</div>
...
<img src="suldef3.jpg" style="border-radius:10px;left:335px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Sulphur Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Deficiency causes chlorosis and delaying of green colour in newly emerging leaves,reduced plant growth and reduced leaf size.  The leaf blades become very soft and tear easily.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
...
<img src="borondef3.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Boron Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Distortion of newer leaves.  Ad the growing point dies.  Leaves show chlorotic symptom.  Bushy appearance of shoot.  Leaves show inward cupping with stunted growth.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of borax 2-3 g/plant</p>
</div>
...
<img src="mangdef3.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
