...
<hr style="border-width:20px; border-color:#64DC17"><div class="hr-container" style="top:-15px;left:41%"><p>POMEGRANATE</p></div></hr>
<p style="font-weight:bold;font-size:18px;">Varieties</p>
Jyothi, Ganesh, Co 1, YCD 1, Araktha, Rudhra, Ruby and Mirudhula are the commercially cultivated pomegranate varieties.<br>
<img src="pom1.png" style="height:200px;width:350px;position:relative;left:250px;top:10px;bottom:10px;border-radius:6px">
...
<p style="font-weight:bold;font-size:18px;">Application of fertilizers: (per plant)</p>
<img src="pom2.png" style="height:100px;width:450px;position:relative;left:200px;top:10px;bottom:10px;border-radius:6px">
<p style="font-weight:bold;font-size:18px;">Training and pruning</p>
...
<p style="font-weight:bold;font-size:18px;">Plant protection<br>Pests<br>Aphids</p>
...
<p style="font-weight:bold;font-size:18px;">Fruit Borer</p>
Bag the fruits with polythene covers during flowering period to prevent egg-laying when the fruits are up to 5 cm diameter. Spray neem oil 3 % or NSKE 5% at the time of butterfly activity. Repeat it if necessary twice at an interval of 15 days. <br>
Adopt Economic Threshold Level (5 eggs/plant with bearing capacity of 60 fruits)<br>
Release T. chilonis @ 1 lakh/acre.<br>
Apply Chlorpyriphos 20EC 2 ml/lit; Malathion 50 EC 2 ml/lit
<p style="font-weight:bold;font-size:18px;">Holes on fruit</p>
<p style="font-weight:bold;font-size:18px;">Scales: </p>
Spray quinalphos 25 EC @ 2.5 ml per lit. of water
