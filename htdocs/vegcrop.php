...
<hr style="border-width:20px;border-color:#149E06;"><div class="hr-container" style="left:380px"><a>Fruit Vegetables</a></div></hr>
 <div class="img-container" style="left:25px;top:70px;width:500px;height:150px">
  ...
  <a href="capcicum.php">
  <img src="capcicum.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Capsicum</div></a>
  </div>
 </div>
   <div class="img-container" style="left:250px;top:250px;width:500px;height:150px">
  <a href="paparika.php">
  <img src="pap.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Paparika</div></a>
  </div>
 </div>
 <div class="img-container" style="left:475px;top:250px;width:500px;height:150px">
  <a href="pumpkin.php">
  <img src="pumpkiin.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Pumpkin</div></a>
  </div>
 </div>
 <div class="img-container" style="left:700px;top:250px;width:500px;height:150px">
  <a href="ribbedgourd.php">
  <img src="ribbedgourd.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Ribbed gourd</div></a>
  </div>
 </div>
   <div class="img-container" style="left:25px;top:430px;width:500px;height:150px">
  <a href="bottlegourd.php">
  ...
  <img src="karela.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Bitter gourd</div></a>
  </div>
 </div>
  <div class="img-container" style="left:475px;top:430px;width:500px;height:150px">
  <a href="cucumber.php">
  <img src="kakdi.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Cucumber</div></a>
  </div>
 </div>
  <div class="img-container" style="left:700px;top:430px;width:500px;height:150px">
  <a href="applegourd.php">
  <img src="tinda.jpg" class="image" style="height:150px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Apple gourd </div></a>
  </div>
 </div>
