...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Coriander)</a></div></hr>
<p style="font-size:22px;font-weight:bold;left:350px;position:relative">Nitrogen Deficiency</p>
<img src="cordef1.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18" align="justify">Foliar spray of urea@1-2%</p>
</div>
</div>
<div class="footer">
