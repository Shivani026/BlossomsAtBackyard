...
<hr style="border-width:20px; border-color:#75B02F"><div class="hr-container" style="position:relative;left:300px;top:-35px;color:black"><a>Deficiencies and Disorders (Arecanut)</a></div></hr>
...
<img src="aredef1.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Nitrogen Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Plants are stunted and generally yellow with lower leaves being most affected. Older leaves are golden yellow colour.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar application of 2% urea thrice at fortnightly interval or soil application of 1-2 kg urea / tree.</p>
</div>
...
<img src="aredef2.jpg" style="border-radius:10px;left:345px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Potassium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Symptoms first appear on oldest leaves and later spreads to young leaves. Translucent yellow or orange spots develop on leaflets. The tree appears yellow and nicky, the trunk in slender with few short leaves. Leaflets with necrotic areas along the margins which later withero. The midrib remain alive. Yellowing more pronounced and accompanied by irregular brown blotches along the edges of leaflets than along the midrib.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of KCl 1.3 kg/tree.</p>
</div>
...
<img src="aredef3.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Application of gypsum 2-5 kg/tree/year.</p>
</div>
...
<img src="aredef4.jpg" style="border-radius:10px;left:350px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Magnesium Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Broad light yellow band along the margin of older leaves. The centre of the leaf remaining green. In severe cases leaflet tips may become necrotic. Older leaves become bronzed and dry appearance. Leaflets show necrosis and turn to reddish brown with translucent spots yellowing starts at the tip and spreads to the base.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of MgSO4 1-2 kg/tree/year.</p>
</div>
...
<img src="aredef5.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
...
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Foliar spray of CuSO4@0.5%</p>
</div>
...
<img src="aredef6.jpg" style="border-radius:10px;left:340px;position:relative;top:0px;width:250px;height:300px">
<p style="font-size:18px;font-weight:bold;">Zinc Deficiency Symptoms</p>
<p style="font-size:18" align="justify">Irregular and chlorite leaf spots, mottled leaf, small leaves, severe dieback of twigs. The area near midrib and lateral veins remain green. Terminal twigs with narrow small erect leaves.</p>
<p style="font-size:18px;font-weight:bold;">Corrective Measure :</p>
<p style="font-size:18" align="justify">Soil application of ZnSO4@0.5kg/tree</p>
</div>
</div>
</div>
<div class="footer">
