...
<hr style="border-width:20px; border-color:#53302D"><div class="hr-container" style="top:-15px;left:41%"><p>CASHEW</p></div></hr>
<img src="cas1.png" style="height:180;width:500px;position:relative;left:170px;top:30px;bottom:10px;border-radius:6px"><br>
<br><br><p style="font-weight:bold;font-size:18px;">Varieties</p>
<img src="cas2.png" style="height:200;width:600px;position:relative;left:120px;top:10px;bottom:10px;border-radius:6px"><br>
...
Mainly propagated by soft wood grafting, air layering and epicotyl grafting<br>
<img src="cas3.png" style="height:250;width:450px;position:relative;left:180px;top:10px;bottom:10px;border-radius:6px"><br>
<p style="font-weight:bold;font-size:18px;">Requirement of plants</p>
