...
<hr style="border-width:20px; border-color:#CF1B5C"><div class="hr-container" style="top:-15px;left:35%"><p>CAPSICUM</p></div></hr>
...
<img src="cap1.jpg" style="height:150px;width:200px;position:relative;left:80px;top:10px;bottom:10px;border-radius:6px">
<img src="cap2.jpg" style="height:150px;width:200px;position:relative;left:150px;top:10px;bottom:10px;border-radius:6px">
<img src="cap3.jpg" style="height:150px;width:200px;position:relative;left:220px;top:10px;bottom:10px;border-radius:6px">
<p style="font-size:15px">
...
<li>Apply 2 kg/ha of Azospirillum and 2 kg/ha of Phosphobacteria by mixing with 20 kg of FYM.</li>
<li>Apply 75 % total recommended dose of super phosphate ie 703 kg / ha as basal.</li>
...
<li>Planting to be done at a spacing of 90 x 60 x 60 cm in the paired row system, using ropes marked at 60 cm spacing.</li>
<li>Gap filling to be done at 7th day after transplanting.</li>
</ul>
</p>
<img src="cap4.jpg" style="height:200px;width:260px;position:relative;left:300px;top:10px;bottom:10px;border-radius:6px">
<p style="font-size:15px">
<p style="font-weight:bold;font-size:20px;">Fertigation schedule for capsicum F1 Hybrid</p>
75% RD of Phosphorous applied as super phosphate = 703 kg / ha</br>
1. 19:19:19 = 79 kg /ha ; 2. 13:0:45 = 300 kg /ha ; 3. 12:61:0 = 37 kg /ha ; 4 Urea = 416 kg /ha
</p>
<img src="cap6.png" style="height:360px;width:700px;position:relative;left:50px;top:20px;bottom:25px;border-radius:6px">
<p style="font-size:15px">
<p style="font-weight:bold;font-size:20px;">Nursery</p>
...
<ul>
<li>Prepare the nursery area of 3 cents with slanting slope of 2 % for the seedling production to cover 1 ha.</li>
<li>Cover the nursery area with 50 % shade net and cover the sides using 40/50 mesh insect proof nylon net.</li>
<li>Form raised beds of 1 m width and convenient length and place HDPV pipes at 2m interval for further protection with polythene sheets during rainy months.</li>
<li>Mix sterilized cocopeat @ 300 kg with 5 kg neem cake along with Azospirillum and phosphobacteria each @ 1 kg. Approximately 1.2 kg of cocopeat is required for filling one protray. 238 protrays (98 cells) are required for the production of 23,334 seedlings, which are required for one hectare adopting a spacing of 90 x 60 x 60 cm in a paired row system.</li>
<li>Sow the treated seed in protrays @ 1 seed per cell.</li>
<li>Cover the seed with cocopeat and keep the trays one above the other and cover with a polythene sheet till germination starts.</li>
<li>After 6 days, place the protrays with germinated seeds individually on the raised beds inside the shade net.</li>
<li>Water with rose-can everyday and drench with 19:19:19 @ 0.5% (5g/l) at 18 days after sowing.</li>
</ul>
...
<p style="font-weight:bold;font-size:20px;">Growth regulator</p>
...
<p style="font-weight:bold;font-size:20px;">Dieback and fruit rot:</p>
Spray Mancozeb @ 2g /l
<p style="font-weight:bold;font-size:20px;">Harvest and yield</p>
Harvest fully matured green fruits before ripening. Yield: 15 tonnes/ha in 150-160 days.
</p>
<img src="cap5.png" style="height:200px;width:260px;position:relative;left:330px;top:20px;bottom:25px;border-radius:6px">
</div>
<div class="footer">
