...
.category-container {
  ...
  border-radius:10px;
  font-color:white;
  background-color: rgba(254, 249, 190,0.7);
}
.img-container {
  position: absolute;
  width:60%;
...
<hr style="border-width:20px; border-color:#53302D"><div class="hr-container"><a>Plantation</a></div></hr>
 <div class="img-container" style="left:25px;top:70px;width:75%">
  ...
  <div class="overlay">
   ...
   <div class="img-container" style="left:615px;top:70px;width:77.5%;height:185px">
  <a href="betel.php">
  <img src="betel.jpg" class="image" style="height:185px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Betelvine</div></a>
  </div>
 </div>
  ...
  <a href="rubber.php">
  <img src="rubber.jpg" class="image">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Rubber</div></a>
  </div>
 </div>
   <div class="img-container" style="left:615px;top:280px;width:75.5%">
  <a href="cashew.php">
  <img src="cashew.jpg" class="image">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Cashew</div></a>
  </div>
 </div>
 <div class="img-container" style="left:175px;top:495px;width:75.5%;height:185px">
  <a href="cocoa.php">
  <img src="cocoa.jpg" class="image" style="height:185px">
  <div class="overlay">
    <div class="text" style="cursor:pointer">Cocoa</div></a>
  </div>
 </div>
 <div class="img-container" style="left:470px;top:495px;width:75%;height:185px">
  <a href="oilpalm.php">
  ...
  <div class="overlay">
    ...
    <hr style="border-width:2px;opacity:0;position:absolute;top:915px;width:100%""><div class="hr-container" style="position:absolute;top:915px"><a></a></div></hr>
 </div>
<div class="footer">
